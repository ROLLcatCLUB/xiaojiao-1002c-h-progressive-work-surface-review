...
STAGE='1002H_PROGRESSIVE_WORK_SURFACE_INTEGRATED_BASELINE_REVIEW_PACKAGE'
FINAL='XIAOJIAO_PROGRESSIVE_WORK_SURFACE_INTEGRATED_BASELINE_REVIEW_PACKAGE_PASS'
SLUG='xiaojiao_progressive_work_surface_integrated_baseline_review_package_1002H'
MARKER='ALL_1002H_PROGRESSIVE_WORK_SURFACE_INTEGRATED_BASELINE_REVIEW_PACKAGE_CHECKS_OK'
SAMPLE='progressive_work_surface_integrated_baseline_1002H.json'
HTMLS=[]
