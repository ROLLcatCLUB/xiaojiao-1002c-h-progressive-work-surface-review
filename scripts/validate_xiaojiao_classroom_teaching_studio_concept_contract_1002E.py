...
STAGE='1002E_CLASSROOM_TEACHING_STUDIO_CONCEPT_CONTRACT'
FINAL='XIAOJIAO_CLASSROOM_TEACHING_STUDIO_CONCEPT_CONTRACT_PASS'
SLUG='xiaojiao_classroom_teaching_studio_concept_contract_1002E'
MARKER='ALL_1002E_CLASSROOM_TEACHING_STUDIO_CONCEPT_CONTRACT_CHECKS_OK'
SAMPLE='classroom_teaching_studio_concept_sample_1002E.json'
HTMLS=[]
