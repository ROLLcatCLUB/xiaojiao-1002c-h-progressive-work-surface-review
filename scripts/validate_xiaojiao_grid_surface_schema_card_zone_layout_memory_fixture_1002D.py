...
STAGE='1002D_GRID_SURFACE_SCHEMA_CARD_ZONE_LAYOUT_MEMORY_FIXTURE'
FINAL='XIAOJIAO_GRID_SURFACE_SCHEMA_CARD_ZONE_LAYOUT_MEMORY_FIXTURE_PASS'
SLUG='xiaojiao_grid_surface_schema_card_zone_layout_memory_fixture_1002D'
MARKER='ALL_1002D_GRID_SURFACE_SCHEMA_CARD_ZONE_LAYOUT_MEMORY_FIXTURE_CHECKS_OK'
SAMPLE='grid_surface_schema_fixture_1002D.json'
HTMLS=[]
