...
STAGE='1002G_STUDENT_EVALUATION_ANALYSIS_BOARD_LOW_FIDELITY_PROTOTYPE'
FINAL='XIAOJIAO_STUDENT_EVALUATION_ANALYSIS_BOARD_LOW_FIDELITY_PROTOTYPE_PASS'
SLUG='xiaojiao_student_evaluation_analysis_board_low_fidelity_prototype_1002G'
MARKER='ALL_1002G_STUDENT_EVALUATION_ANALYSIS_BOARD_LOW_FIDELITY_PROTOTYPE_CHECKS_OK'
SAMPLE='student_evaluation_analysis_board_fixture_1002G.json'
HTMLS=["student_evaluation_analysis_board.html"]
